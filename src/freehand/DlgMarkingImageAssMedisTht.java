 ...
 * @author perpustakaan
 */
public class DlgMarkingImageAssMedisTht extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DlgMarkingImageAssMedisTht(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
...
//        setSize(885,674); 
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Marking Lokalis Asesmen Awal Medis THT ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Fira Sans", 0, 13), new java.awt.Color(70, 70, 70))); // NOI18N
        ...
        PilihWarna.setBounds(650, 10, 76, 24);
        ...
        PanelWall.setBackgroundImage(new javax.swing.ImageIcon(getClass().getResource("/picture/medis awal THT-putih.png"))); // NOI18N
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        ...
        try {
            ...
            Logger.getLogger(DlgMarkingImageAssMedisTht.class.getName()).log(Level.SEVERE, null, ex);
        }
        Rectangle capture = 
            new Rectangle(Toolkit.getDefaultToolkit().getScreenSize());
            BufferedImage Image = r.createScreenCapture(panelGlass9.bounds());
        try {
            ImageIO.write(Image, "png", new File("tmpImageFreehand/assMdsTht"+TNoRawat.getText().replaceAll("/", "")+".png"));
        } catch (IOException ex) {
            Logger.getLogger(DlgMarkingImageAssMedisTht.class.getName()).log(Level.SEVERE, null, ex);
        }
        uploadImage("assMdsTht"+TNoRawat.getText().replaceAll("/", "")+".png","assesmentmedismata/imagemarking");
        
        if(Sequel.cariInteger("select count(no_rawat) as jumlah from asesmen_medis_tht_image_marking where no_rawat='"+TNoRawat.getText()+"'")>0){
            if(Sequel.mengedittf("asesmen_medis_tht_image_marking","no_rawat=?","tanggal=?,jam=?,url_image=?",4,new String[]{
                   tanggalNow.format(new Date()),jamNow.format(new Date()),"assesmentmedismata/imagemarking/assMdsTht"+TNoRawat.getText().replaceAll("/", "")+".png",TNoRawat.getText()
                     })==true){
                
            }
        }else{
         if(Sequel.menyimpantf("asesmen_medis_tht_image_marking","?,?,?,?","No.Rawat",4,new String[]{
                    TNoRawat.getText(),tanggalNow.format(new Date()),jamNow.format(new Date()),"assesmentmedismata/imagemarking/assMdsTht"+TNoRawat.getText().replaceAll("/", "")+".png"
                })==true){
            }
        }
        dispose();
...
//        System.out.println(index);
    ...
    private void BtnHapus1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapus1ActionPerformed
        imageAssesment("http://"+koneksiDB.HOSTHYBRIDWEB()+":"+koneksiDB.PORTWEB()+"/"+koneksiDB.HYBRIDWEB()+"/imagefreehand/masterimage/medis_awal_THT-putih.png");
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgMarkingImageAssMedisTht dialog = new DlgMarkingImageAssMedisTht(new javax.swing.JFrame(), true);
...
//        Sequel.cariIsi("select nm_pasien from pasien where no_rkm_medis=? ",TPasien,TNoRM.getText());
    ...
    public void setNoRw(String norw) {
        ...
        urlImage=Sequel.cariIsi("select url_image from asesmen_medis_tht_image_marking where no_rawat='"+norw+"' ");
