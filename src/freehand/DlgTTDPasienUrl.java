 ...
 * @author perpustakaan
 */
public class DlgTTDPasienUrl extends javax.swing.JDialog {
     ...
     * @param modal
     */
    public DlgTTDPasienUrl(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
...
//        setSize(300,300);
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), ".:[ Tanda Tangan Pasien Program Fisioterapi ]:.", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Helvetica Neue", 0, 13), new java.awt.Color(70, 70, 70))); // NOI18N
    ...
    //    String filePath = "tmpImageFreehand/ttdrehabpertama" + TNoRW.getText().replaceAll("/", "") + ".png";
        ...
        if(Sequel.cariInteger("select count(no_rawat) as jumlah from rehab_program_image_marking where no_rawat='"+TNoRW.getText()+"'")>0){
            if(Sequel.mengedittf("rehab_program_image_marking","no_rawat=?","tanggal=?,jam=?,url_image=?",4,new String[]{
                   tanggalNow.format(new Date()),jamNow.format(new Date()),"rehabmedik/program/RP"+TNoRW.getText().replaceAll("/", "")+".png",TNoRW.getText()
                     })==true){
                
            }
        }else{
         if(Sequel.menyimpantf("rehab_program_image_marking","?,?,?,?","No.Rawat",4,new String[]{
                    TNoRW.getText(),tanggalNow.format(new Date()),jamNow.format(new Date()),"rehabmedik/program/RP"+TNoRW.getText().replaceAll("/", "")+".png"
                })==true){
            }
        }
        ...
        Logger.getLogger(DlgTTDPasienUrl.class.getName()).log(Level.SEVERE, null, ex);
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgTTDPasienUrl dialog = new DlgTTDPasienUrl(new javax.swing.JFrame(), true);
