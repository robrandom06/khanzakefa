...
//                        kdpoli.requestFocus();
                        ...
                        kdpoli3.setText(poli.getTable().getValueAt(poli.getTable().getSelectedRow(), 0).toString());
                        nmpoli3.setText(poli.getTable().getValueAt(poli.getTable().getSelectedRow(), 1).toString());
                        kdpoli3.requestFocus();
                    }
                }
            }
    ...
    private void initComponents() {
        ...
        BtnPoliklinik = new widget.Button();
        ...
        panelGlass4.setPreferredSize(new java.awt.Dimension(711, 138));
        ...
        jLabel13.setText("Polliklinik :");
        jLabel13.setName("jLabel13"); // NOI18N
        panelGlass4.add(jLabel13);
        jLabel13.setBounds(0, 100, 120, 23);

        kdpoli3.setHighlighter(null);
        kdpoli3.setName("kdpoli3"); // NOI18N
        kdpoli3.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                kdpoli3KeyPressed(evt);
            }
        });
        panelGlass4.add(kdpoli3);
        kdpoli3.setBounds(123, 100, 100, 23);

        nmpoli3.setEditable(false);
        nmpoli3.setHighlighter(null);
        nmpoli3.setName("nmpoli3"); // NOI18N
        nmpoli3.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                nmpoli3KeyPressed(evt);
            }
        });
        panelGlass4.add(nmpoli3);
        nmpoli3.setBounds(225, 100, 252, 23);

        BtnPoliklinik.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/190.png"))); // NOI18N
        BtnPoliklinik.setMnemonic('1');
        BtnPoliklinik.setToolTipText("Alt+1");
        BtnPoliklinik.setName("BtnPoliklinik"); // NOI18N
        BtnPoliklinik.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnPoliklinikActionPerformed(evt);
            }
        });
        panelGlass4.add(BtnPoliklinik);
        BtnPoliklinik.setBounds(480, 100, 28, 23);
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if (TabRawat.getSelectedIndex() == 0) {
            ...
            if (kddokter3.getText().trim().equals("") || nmdokter3.getText().trim().equals("")) {
                ...
                if (Sequel.menyimpantf(
                        "set_otomatis_tindakan_ralan_dokterpetugas", "'" + kddokter3.getText() + "','" + kdtindakan3.getText() + "','" + kdpj3.getText() + "','" + kdpoli3.getText() + "'",
                        "Tindakan") == true) {
                    tampil3();
                    emptTeks3();
                }
...
private void kdtindakanKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_kdtindakanKeyPressed
    ...
    private void kdpoli3KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_kdpoli3KeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_kdpoli3KeyPressed

    private void nmpoli3KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_nmpoli3KeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_nmpoli3KeyPressed
    ...
    private widget.Button BtnPoliklinik;
    ...
    private void tampil3() {
        ...
        try {
            ps = koneksi.prepareStatement(
                    ...
                    + "set_otomatis_tindakan_ralan_dokterpetugas.kd_poli,poliklinik.nm_poli "
                    ...
                    + "set_otomatis_tindakan_ralan_dokterpetugas.kd_poli like ? or "
    ...
    private void getData3() {
        ...
        if (row != -1) {
            ...
            kdpoli3.setText(Table3.getValueAt(row, 6).toString());
            nmpoli3.setText(Table3.getValueAt(row, 7).toString());
        }
    }
