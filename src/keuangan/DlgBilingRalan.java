...
public class DlgBilingRalan extends javax.swing.JDialog {
    ...
    private String nota_jalan = "", dokterrujukan = "", polirujukan = "", status = "", biaya = "", tambahan = "", totals = "", kdptg = "", nmptg = "", kd_pj = "", notaralan = "", centangdokterralan = "",
            ...
            Host_to_Host_Bank_Jateng = "", Akun_BRI_API = "", Host_to_Host_Bank_Papua = "", Host_to_Host_Bank_Jabar = "", Host_to_Host_Bank_Mandiri = "", KodeBankJabar = "", PPN_Keluaran = "",kodeberkas="";
    ...
    private void BtnNotaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnNotaActionPerformed
        if (TNoRw.getText().trim().equals("") || TNoRM.getText().trim().equals("") || TPasien.getText().trim().equals("")) {
            ...
            try {
                ...
                i = 0;
                try {
                    biaya = (String) JOptionPane.showInputDialog(null, "Silahkan pilih nota yang mau dicetak!", "Nota", JOptionPane.QUESTION_MESSAGE, null, new Object[]{"Nota", "Kwitansi", "Nota & Kwitansi", "Kwitansi Piutang", "Upload Nota Ke Berkas Digital"}, "Nota");
                    switch (biaya) {
                        case "Nota":
                            i = 1;
                            break;
                ...
                if (i > 0) {
                    ...
                    if (i == 1) {
                        ...
                        String url = "http://" + koneksiDB.HOSTHYBRIDWEB() + ":"
                                + koneksiDB.PORTWEB() + "/"
                                + koneksiDB.HYBRIDWEB()
                                + "/billing/LaporanBilling.php?petugas="
