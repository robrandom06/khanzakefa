            ...
            if (kenaikan > 0) {
                ...
                if (aktifkanbatch.equals("yes")) {
                    ...
                    try {
                        ...
                        pstampil.setString(12, "%" + TCari.getText().trim() + "%");
                        rstampil = pstampil.executeQuery();
                        StringBuilder obatKurangStok = new StringBuilder();

                        while (rstampil.next()) {
                            double jumlahDiminta = rstampil.getDouble("jml");
                            double stokTersedia = rstampil.getDouble("stok");

                            if (jumlahDiminta > stokTersedia) {
                                obatKurangStok.append("- ")
                                        .append(rstampil.getString("nama_brng"))
                                        .append(" (Diminta: ")
                                        .append(jumlahDiminta)
                                        .append(", Stok: ")
                                        .append(stokTersedia)
                                        .append(")\n");
                            }
                        ...
                        if (obatKurangStok.length() > 0) {
                            JOptionPane.showMessageDialog(rootPane,
                                    "Maaf, stok tidak mencukupi untuk item berikut:\n\n" + obatKurangStok.toString(),
                                    "Peringatan Stok",
