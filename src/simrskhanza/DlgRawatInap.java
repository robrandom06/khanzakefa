...
public final class DlgRawatInap extends javax.swing.JDialog {
    ...
    public DlgRawatInap(java.awt.Frame parent, boolean modal) {
        ...
        tabModePemeriksaanSbar = new DefaultTableModel(null, new Object[]{
            ...
            "Situation", "Background", "Assesment", "Recommendation", "NIP", "Dokter/Paramedis", "Profesi/Jabatan", "Status Verifikasi", "Kode DPJP", "Nama DPJP"}) {
            @Override
            public boolean isCellEditable(int rowIndex, int colIndex) {
                boolean a = false;
                if (colIndex == 0) {
...
//                if (akses.getform().equals("DlgRawatInap")) {
//                    if (pegawai2.getTable().getSelectedRow() != -1) {
//                        if (TabRawat.getSelectedIndex() == 7) {
...
//        });
                ...
                if (akses.getform().equals("DlgRawatInap")) {
                    if (perawatan.dokter.getTable().getSelectedRow() != -1) {
                        if (TabRawat.getSelectedIndex() == 0) {
                            ...
                            KdDok1.setText(perawatan.dokter.getTable().getValueAt(perawatan.dokter.getTable().getSelectedRow(), 0).toString());
                            TDokter1.setText(perawatan.dokter.getTable().getValueAt(perawatan.dokter.getTable().getSelectedRow(), 1).toString());
                            KdDok1.requestFocus();
                        }
                    }
                }
    ...
    private void initComponents() {
        ...
        button2.setBounds(930, 30, 160, 30);
        ...
        BtnPintasEResep.setBounds(930, 100, 160, 30);
        ...
        BtnPintasPermintaanLab.setBounds(930, 130, 160, 30);
        ...
        BtnPintasPermintaanRadiologi.setBounds(930, 160, 160, 30);
        ...
        BtnPintasResume.setBounds(930, 190, 160, 30);
        ...
        TPegawai3.setBounds(310, 610, 212, 23);
        ...
        KdPeg3.setBounds(190, 610, 115, 23);
        ...
        jLabel70.setBounds(60, 610, 140, 23);
        ...
        BtnVerifSbar.setBounds(930, 50, 28, 23);
        ...
        jLabel84.setBounds(970, 50, 200, 23);

        jLabel86.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel86.setText("Data Verifikasi SBAR");
        ...
        jLabel86.setBounds(970, 100, 150, 23);

        BtnVerifSbar3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/peminjaman.png"))); // NOI18N
        ...
        panelGlass16.add(BtnVerifSbar3);
        BtnVerifSbar3.setBounds(930, 100, 28, 23);

        jLabel24.setText("DPJP:");
        jLabel24.setName("jLabel24"); // NOI18N
        panelGlass16.add(jLabel24);
        jLabel24.setBounds(65, 210, 50, 23);
        ...
        panelGlass16.add(KdDok1);
        KdDok1.setBounds(120, 210, 130, 23);

        TDokter1.setEditable(false);
        TDokter1.setHighlighter(null);
        TDokter1.setName("TDokter1"); // NOI18N
        panelGlass16.add(TDokter1);
        TDokter1.setBounds(250, 210, 606, 23);
        ...
        panelGlass16.add(BtnSeekDokter1);
        BtnSeekDokter1.setBounds(860, 210, 28, 23);
                        ...
                        if (KdPeg2.getText().trim().equals("") || TPegawai2.getText().trim().equals("")) {
                            ...
                            if (akses.getkode().equals("Admin Utama")) {
                                Sequel.menyimpan("pemeriksaan_ranap_sbar", "?,?,?,?,?,?,?,?,?", "Data", 9, new String[]{
                                    TNoRw.getText(), Valid.SetTgl(DTPTgl.getSelectedItem() + ""), cmbJam.getSelectedItem() + ":" + cmbMnt.getSelectedItem() + ":" + cmbDtk.getSelectedItem(),
                                    TSituation.getText(), TBackground.getText(), TAssesment.getText(), TRecommendation.getText(), KdPeg2.getText(), KdDok1.getText()
                                });
                                tampilPemeriksaanSbar();
                    ...
                    if (tbPemeriksaanSbar.getSelectedRow() > -1) {
                        if (akses.getkode().equals("Admin Utama")) {
                            Sequel.mengedit("pemeriksaan_ranap_sbar", "no_rawat='" + tbPemeriksaanSbar.getValueAt(tbPemeriksaanSbar.getSelectedRow(), 1)
                                    ...
                                    + "jam_rawat='" + cmbJam.getSelectedItem() + ":" + cmbMnt.getSelectedItem() + ":" + cmbDtk.getSelectedItem() + "',"
                                    + "nip='" + KdPeg2.getText() + "',kd_dokter='" + KdDok1.getText() + "'");
                            tampilPemeriksaanSbar();
                            BtnBatalActionPerformed(evt);
                        } else {
...
//            this.setCursor(Cursor.getDefaultCursor());
    ...
    private void getDataPemeriksaanSbar() {
        if (tbPemeriksaanSbar.getSelectedRow() != -1) {
            ...
            KdDok1.setText(tbPemeriksaanSbar.getValueAt(tbPemeriksaanSbar.getSelectedRow(), 14).toString());
            TDokter1.setText(tbPemeriksaanSbar.getValueAt(tbPemeriksaanSbar.getSelectedRow(), 15).toString());
        }
    }
    ...
    private void tampilPemeriksaanSbar() {
        ...
        try {
            ps7 = koneksi.prepareStatement("select pemeriksaan_ranap_sbar.no_rawat,reg_periksa.no_rkm_medis,pasien.nm_pasien,"
                    ...
                    + "pemeriksaan_ranap_sbar.assesment,pemeriksaan_ranap_sbar.recommendation,pemeriksaan_ranap_sbar.nip,pegawai.nama,pegawai.jbtn, IF(vps.no_rawat IS NOT NULL, 'Tervalidasi', 'Belum Divalidasi'),pemeriksaan_ranap_sbar.kd_dokter,dokter.nm_dokter "
                    + "from pasien inner join reg_periksa on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "
