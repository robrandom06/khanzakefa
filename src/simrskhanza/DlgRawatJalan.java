...
public final class DlgRawatJalan extends javax.swing.JDialog {
    ...
    private final DefaultTableModel tabModeDr, tabModePr, tabModeDrPr,
            ...
            TabModeTindakan, TabModeTindakan2, TabModeTindakan3, TabModeCatatan, TabModeProtokol;
    ...
    private int i = 0, jmlparsial = 0, jml = 0, index = 0, tinggi = 0, pilihan = 1;
    ...
    public DlgRawatJalan(java.awt.Frame parent, boolean modal) {
        ...
        TabModeProtokol = new DefaultTableModel(null, new Object[]{
            "P", "No.Rawat", "No.R.M.", "Nama Pasien", "Tanggal", "Jam", "NIP", "Petugas", "Program"}) {
            @Override
            public boolean isCellEditable(int rowIndex, int colIndex) {
                boolean a = false;
                if (colIndex == 0) {
        ...
        tbProtokol.setModel(TabModeProtokol);
                ...
                if (akses.getform().equals("DlgRawatJalan")) {
                    if (petugas.getTable().getSelectedRow() != -1) {
                        ...
                        if (TabRawat.getSelectedIndex() == 2) {
                            ...
                            kdptg4.setText(petugas.getTable().getValueAt(petugas.getTable().getSelectedRow(), 0).toString());
            ...
            public void windowClosed(WindowEvent e) {
                if (soapterakhir.getTable().getSelectedRow() != -1) {
                    if (pilihan == 1) {
                        ...
                        DiagnosaTerapi.setText(soapterakhir.getTable().getValueAt(soapterakhir.getTable().getSelectedRow(), 4).toString());
                        TataLaksana.setText(soapterakhir.getTable().getValueAt(soapterakhir.getTable().getSelectedRow(), 5).toString());
    ...
    private void initComponents() {
        ...
        DiagnosaTerapi = new widget.TextBox();
        jLabel66 = new widget.Label();
        jLabel68 = new widget.Label();
        jLabel69 = new widget.Label();
        jScrollPane1 = new javax.swing.JScrollPane();
        Evaluasi = new javax.swing.JTextArea();
        jScrollPane2 = new javax.swing.JScrollPane();
        TataLaksana = new javax.swing.JTextArea();
        jScrollPane3 = new javax.swing.JScrollPane();
        Anjuran = new javax.swing.JTextArea();
        PemeriksaanFisik = new widget.TextBox();
        jPopupMenu1 = new javax.swing.JPopupMenu();
        MnAmbilTTDPasien = new javax.swing.JMenuItem();
        ...
        BtnPintasResume = new widget.Button();
        BtnPintasPermintaanRadiologi = new widget.Button();
        BtnPintasPermintaanLab = new widget.Button();
        BtnPintasEResep = new widget.Button();
        ...
        kdptg4 = new widget.TextBox();
        NamaPetugas = new widget.TextBox();
        BtnSeekPetugas4 = new widget.Button();
        ...
        internalFrame10.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(230, 235, 225)), "::[ Cetak Lembar Formulir Rawat Jalan Layanan Kedokteran Fisik & Rehabilitasi ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 70, 50))); // NOI18N
        ...
        BtnPrint5.setBounds(30, 340, 100, 30);
        ...
        BtnKeluar4.setBounds(450, 340, 100, 30);

        Anamnesa.setEditable(false);
        Anamnesa.setName("Anamnesa"); // NOI18N
        Anamnesa.setPreferredSize(new java.awt.Dimension(300, 23));
        panelBiasa4.add(Anamnesa);
        Anamnesa.setBounds(160, 10, 330, 23);

        jLabel61.setText("Pemeriksaan Fisik  :");
        jLabel61.setName("jLabel61"); // NOI18N
        jLabel61.setPreferredSize(new java.awt.Dimension(60, 23));
        panelBiasa4.add(jLabel61);
        jLabel61.setBounds(10, 40, 140, 23);

        jLabel63.setText("Anamnesa :");
        jLabel63.setName("jLabel63"); // NOI18N
        jLabel63.setPreferredSize(new java.awt.Dimension(60, 23));
        panelBiasa4.add(jLabel63);
        jLabel63.setBounds(10, 10, 140, 23);
        ...
        BtnSeek6.setBounds(510, 90, 28, 23);

        jLabel65.setText("Diagnosa Medis :");
        jLabel65.setName("jLabel65"); // NOI18N
        jLabel65.setPreferredSize(new java.awt.Dimension(60, 23));
        panelBiasa4.add(jLabel65);
        jLabel65.setBounds(10, 70, 140, 23);

        DiagnosaTerapi.setEditable(false);
        DiagnosaTerapi.setName("DiagnosaTerapi"); // NOI18N
        DiagnosaTerapi.setPreferredSize(new java.awt.Dimension(300, 23));
        panelBiasa4.add(DiagnosaTerapi);
        DiagnosaTerapi.setBounds(160, 70, 330, 23);

        jLabel66.setText("Tata Laksana :");
        jLabel66.setName("jLabel66"); // NOI18N
        jLabel66.setPreferredSize(new java.awt.Dimension(60, 23));
        panelBiasa4.add(jLabel66);
        jLabel66.setBounds(10, 110, 140, 23);

        jLabel68.setText("Anjuran :");
        jLabel68.setName("jLabel68"); // NOI18N
        jLabel68.setPreferredSize(new java.awt.Dimension(60, 23));
        panelBiasa4.add(jLabel68);
        jLabel68.setBounds(10, 200, 140, 23);

        jLabel69.setText("Evaluasi :");
        jLabel69.setName("jLabel69"); // NOI18N
        jLabel69.setPreferredSize(new java.awt.Dimension(60, 23));
        panelBiasa4.add(jLabel69);
        jLabel69.setBounds(10, 270, 140, 23);
        ...
        jScrollPane1.setViewportView(Evaluasi);

        panelBiasa4.add(jScrollPane1);
        jScrollPane1.setBounds(160, 270, 330, 60);
        ...
        jScrollPane2.setViewportView(TataLaksana);

        panelBiasa4.add(jScrollPane2);
        jScrollPane2.setBounds(160, 110, 330, 86);
        ...
        jScrollPane3.setViewportView(Anjuran);

        panelBiasa4.add(jScrollPane3);
        jScrollPane3.setBounds(160, 200, 330, 60);

        PemeriksaanFisik.setEditable(false);
        PemeriksaanFisik.setName("PemeriksaanFisik"); // NOI18N
        PemeriksaanFisik.setPreferredSize(new java.awt.Dimension(300, 23));
        panelBiasa4.add(PemeriksaanFisik);
        PemeriksaanFisik.setBounds(160, 40, 330, 23);

        internalFrame10.add(panelBiasa4, java.awt.BorderLayout.CENTER);

        DlgCetak.getContentPane().add(internalFrame10, java.awt.BorderLayout.CENTER);

        jPopupMenu1.setName("jPopupMenu1"); // NOI18N

        MnAmbilTTDPasien.setBackground(new java.awt.Color(255, 255, 254));
        MnAmbilTTDPasien.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnAmbilTTDPasien.setForeground(new java.awt.Color(50, 50, 50));
        MnAmbilTTDPasien.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        MnAmbilTTDPasien.setText("Ambil TTD Pasien");
        MnAmbilTTDPasien.setName("MnAmbilTTDPasien"); // NOI18N
        MnAmbilTTDPasien.setPreferredSize(new java.awt.Dimension(270, 26));
        MnAmbilTTDPasien.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnAmbilTTDPasienActionPerformed(evt);
            }
        });
        jPopupMenu1.add(MnAmbilTTDPasien);
        ...
        BtnSeekPetugas.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                BtnSeekPetugasMouseClicked(evt);
            }
        });
        ...
        button2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/DutyRoster.png"))); // NOI18N
        button2.setText("Riwayat SOAP");
        button2.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        button2.setGlassColor(new java.awt.Color(97, 179, 241));
        button2.setMaximumSize(new java.awt.Dimension(132, 30));
        button2.setMinimumSize(new java.awt.Dimension(132, 30));
        button2.setName("button2"); // NOI18N
        button2.setPreferredSize(new java.awt.Dimension(132, 30));
        panelGlass12.add(button2);
        button2.setBounds(920, 40, 160, 30);

        BtnPintasResume.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/Add patient SH.png"))); // NOI18N
        BtnPintasResume.setText("Resume Pasien");
        BtnPintasResume.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        BtnPintasResume.setGlassColor(new java.awt.Color(97, 179, 241));
        BtnPintasResume.setMaximumSize(new java.awt.Dimension(120, 30));
        BtnPintasResume.setMinimumSize(new java.awt.Dimension(120, 30));
        BtnPintasResume.setName("BtnPintasResume"); // NOI18N
        BtnPintasResume.setPreferredSize(new java.awt.Dimension(120, 30));
        BtnPintasResume.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnPintasResumeActionPerformed(evt);
            }
        });
        panelGlass12.add(BtnPintasResume);
        BtnPintasResume.setBounds(920, 210, 160, 30);

        BtnPintasPermintaanRadiologi.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/Task.png"))); // NOI18N
        BtnPintasPermintaanRadiologi.setText("Permintaan Radiologi");
        BtnPintasPermintaanRadiologi.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        BtnPintasPermintaanRadiologi.setGlassColor(new java.awt.Color(97, 179, 241));
        BtnPintasPermintaanRadiologi.setMaximumSize(new java.awt.Dimension(132, 30));
        BtnPintasPermintaanRadiologi.setMinimumSize(new java.awt.Dimension(132, 30));
        BtnPintasPermintaanRadiologi.setName("BtnPintasPermintaanRadiologi"); // NOI18N
        BtnPintasPermintaanRadiologi.setPreferredSize(new java.awt.Dimension(132, 30));
        BtnPintasPermintaanRadiologi.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnPintasPermintaanRadiologiActionPerformed(evt);
            }
        });
        panelGlass12.add(BtnPintasPermintaanRadiologi);
        BtnPintasPermintaanRadiologi.setBounds(920, 180, 160, 30);

        BtnPintasPermintaanLab.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/TestTubes.png"))); // NOI18N
        BtnPintasPermintaanLab.setText("Permintaan Laborat");
        BtnPintasPermintaanLab.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        BtnPintasPermintaanLab.setGlassColor(new java.awt.Color(97, 179, 241));
        BtnPintasPermintaanLab.setMaximumSize(new java.awt.Dimension(132, 30));
        BtnPintasPermintaanLab.setMinimumSize(new java.awt.Dimension(132, 30));
        BtnPintasPermintaanLab.setName("BtnPintasPermintaanLab"); // NOI18N
        BtnPintasPermintaanLab.setPreferredSize(new java.awt.Dimension(132, 30));
        BtnPintasPermintaanLab.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnPintasPermintaanLabActionPerformed(evt);
            }
        });
        panelGlass12.add(BtnPintasPermintaanLab);
        BtnPintasPermintaanLab.setBounds(920, 150, 160, 30);

        BtnPintasEResep.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/Pills.png"))); // NOI18N
        BtnPintasEResep.setText("Input E-Resep");
        BtnPintasEResep.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        BtnPintasEResep.setGlassColor(new java.awt.Color(97, 179, 241));
        BtnPintasEResep.setMaximumSize(new java.awt.Dimension(132, 30));
        BtnPintasEResep.setMinimumSize(new java.awt.Dimension(132, 30));
        BtnPintasEResep.setName("BtnPintasEResep"); // NOI18N
        BtnPintasEResep.setPreferredSize(new java.awt.Dimension(132, 30));
        BtnPintasEResep.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnPintasEResepActionPerformed(evt);
            }
        });
        panelGlass12.add(BtnPintasEResep);
        BtnPintasEResep.setBounds(920, 120, 160, 30);
        ...
        PanelInput4.setPreferredSize(new java.awt.Dimension(192, 140));
        ...
        panelGlass16.setPreferredSize(new java.awt.Dimension(44, 104));
        panelGlass16.setLayout(null);

        jLabel58.setText("Program :");
        jLabel58.setName("jLabel58"); // NOI18N
        panelGlass16.add(jLabel58);
        jLabel58.setBounds(0, 40, 60, 23);
        ...
        scrollPane5.setViewportView(Catatan1);

        panelGlass16.add(scrollPane5);
        scrollPane5.setBounds(64, 40, 713, 68);

        jLabel59.setText("Petugas :");
        jLabel59.setName("jLabel59"); // NOI18N
        panelGlass16.add(jLabel59);
        jLabel59.setBounds(0, 10, 60, 23);

        kdptg4.setHighlighter(null);
        kdptg4.setName("kdptg4"); // NOI18N
        kdptg4.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                kdptg4KeyPressed(evt);
            }
        });
        panelGlass16.add(kdptg4);
        kdptg4.setBounds(64, 10, 146, 23);

        NamaPetugas.setEditable(false);
        NamaPetugas.setHighlighter(null);
        NamaPetugas.setName("NamaPetugas"); // NOI18N
        panelGlass16.add(NamaPetugas);
        NamaPetugas.setBounds(212, 10, 534, 23);

        BtnSeekPetugas4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/190.png"))); // NOI18N
        BtnSeekPetugas4.setMnemonic('4');
        BtnSeekPetugas4.setToolTipText("ALt+4");
        BtnSeekPetugas4.setName("BtnSeekPetugas4"); // NOI18N
        BtnSeekPetugas4.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                BtnSeekPetugas4MouseClicked(evt);
            }
        });
        BtnSeekPetugas4.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnSeekPetugas4ActionPerformed(evt);
            }
        });
        panelGlass16.add(BtnSeekPetugas4);
        BtnSeekPetugas4.setBounds(749, 10, 28, 23);
        ...
        tbProtokol.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                tbProtokolKeyReleased(evt);
            }
        });
        Scroll12.setViewportView(tbProtokol);

        internalFrame9.add(Scroll12, java.awt.BorderLayout.CENTER);

        TabRawat.addTab("Protokol Terapi", internalFrame9);
        ...
        DTPTgl.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "01-03-2025" }));
        ...
        if (TNoRw.getText().trim().equals("") || TPasien.getText().trim().equals("")) {
            ...
            switch (TabRawat.getSelectedIndex()) {
                ...
                case 7:
                    ...
                    break;
                case 8:
                    if ((!kdptg4.getText().trim().equals("")) && (!NamaPetugas.getText().trim().equals("")) && (!Catatan1.getText().trim().equals(""))) {
                        if (Sequel.menyimpantf("rehab_program", "?,?,?,?,?", "Data", 5, new String[]{
                            Valid.SetTgl(DTPTgl.getSelectedItem() + ""), cmbJam.getSelectedItem() + ":" + cmbMnt.getSelectedItem() + ":" + cmbDtk.getSelectedItem(),
                            TNoRw.getText(), kdptg4.getText(), Catatan1.getText()
                        }) == true) {
                            TabModeProtokol.addRow(new Object[]{
                                false, TNoRw.getText(), TNoRM.getText(), TPasien.getText(), Valid.SetTgl(DTPTgl.getSelectedItem() + ""), cmbJam.getSelectedItem() + ":" + cmbMnt.getSelectedItem() + ":" + cmbDtk.getSelectedItem(), kdptg4.getText(), NamaPetugas.getText(), Catatan1.getText()
                            });
                            Catatan1.setText("");
                            LCount.setText("" + TabModeProtokol.getRowCount());
                        }
                    }
                    break;
                default:
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        switch (TabRawat.getSelectedIndex()) {
            ...
            case 7:
                ...
                break;
            case 8:
                if (TabModeProtokol.getRowCount() == 0) {
                    JOptionPane.showMessageDialog(null, "Maaf, data sudah habis...!!!!");
                    TNoRw.requestFocus();
                } else {
                    for (i = 0; i < tbProtokol.getRowCount(); i++) {
                        if (tbProtokol.getValueAt(i, 0).toString().equals("true")) {
                            Sequel.queryu("delete from rehab_program where no_rawat='" + tbProtokol.getValueAt(i, 1).toString()
                                    + "' and tanggal='" + tbProtokol.getValueAt(i, 4).toString()
                                    + "' and jam='" + tbProtokol.getValueAt(i, 5).toString()
                                    + "' and kd_petugas='" + tbProtokol.getValueAt(i, 6).toString() + "' ");
                            TabModeProtokol.removeRow(i);
                            i--;
                        }
                    }
                    LCount.setText("" + TabModeProtokol.getRowCount());
    ...
    if (TNoRw.getText().trim().equals("") || TPasien.getText().trim().equals("")) {
        ...
        switch (TabRawat.getSelectedIndex()) {
            ...
            case 7:
                ...
                break;
            case 8:
                if (!Catatan1.getText().trim().equals("")) {
                    if (tbProtokol.getSelectedRow() > -1) {
                        if (Sequel.mengedittf("rehab_program", "no_rawat='" + tbProtokol.getValueAt(tbProtokol.getSelectedRow(), 1)
                                + "' and tanggal='" + tbProtokol.getValueAt(tbProtokol.getSelectedRow(), 4)
                                + "' and jam='" + tbProtokol.getValueAt(tbProtokol.getSelectedRow(), 5)
                                + "' and kd_petugas='" + tbProtokol.getValueAt(tbProtokol.getSelectedRow(), 6) + "'",
                                "no_rawat='" + TNoRw.getText() + "',program='" + Catatan1.getText() + "',"
                                + "kd_petugas='" + kdptg4.getText() + "',tanggal='" + Valid.SetTgl(DTPTgl.getSelectedItem() + "") + "',"
                                + "jam='" + cmbJam.getSelectedItem() + ":" + cmbMnt.getSelectedItem() + ":" + cmbDtk.getSelectedItem() + "'") == true) {
                            tbProtokol.setValueAt(TNoRw.getText(), tbProtokol.getSelectedRow(), 1);
                            tbProtokol.setValueAt(TNoRM.getText(), tbProtokol.getSelectedRow(), 2);
                            tbProtokol.setValueAt(TPasien.getText(), tbProtokol.getSelectedRow(), 3);
                            tbProtokol.setValueAt(Valid.SetTgl(DTPTgl.getSelectedItem() + ""), tbProtokol.getSelectedRow(), 4);
                            tbProtokol.setValueAt(cmbJam.getSelectedItem() + ":" + cmbMnt.getSelectedItem() + ":" + cmbDtk.getSelectedItem(), tbProtokol.getSelectedRow(), 5);
                            tbProtokol.setValueAt(kdptg4.getText(), tbProtokol.getSelectedRow(), 6);
                            tbProtokol.setValueAt(NamaPetugas.getText(), tbProtokol.getSelectedRow(), 7);
                            tbProtokol.setValueAt(Catatan1.getText(), tbProtokol.getSelectedRow(), 8);
                            Catatan.setText("");
                        }
                    } else {
                        JOptionPane.showMessageDialog(rootPane, "Silahkan pilih data yang mau diganti..!!");
...
private void BtnEditKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnEditKeyPressed
    ...
    private void BtnPintasResumeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPintasResumeActionPerformed
        if (TNoRw.getText().trim().equals("")) {
            JOptionPane.showMessageDialog(null, "Maaf, Silahkan anda pilih dulu dengan menklik data pada table...!!!");
            TCari.requestFocus();
        } else {
    ...
    }//GEN-LAST:event_BtnPintasResumeActionPerformed

    private void BtnPintasPermintaanRadiologiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPintasPermintaanRadiologiActionPerformed
        if (TPasien.getText().trim().equals("") || TNoRw.getText().trim().equals("")) {
            JOptionPane.showMessageDialog(null, "Maaf, Silahkan anda pilih dulu dengan menklik data pada table...!!!");
            TCari.requestFocus();
        } else {
    ...
    }//GEN-LAST:event_BtnPintasPermintaanRadiologiActionPerformed

    private void BtnPintasPermintaanLabActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPintasPermintaanLabActionPerformed
        if (TPasien.getText().trim().equals("") || TNoRw.getText().trim().equals("")) {
            JOptionPane.showMessageDialog(null, "Maaf, Silahkan anda pilih dulu dengan menklik data pada table...!!!");
            TCari.requestFocus();
        } else {
    ...
    }//GEN-LAST:event_BtnPintasPermintaanLabActionPerformed

    private void BtnPintasEResepActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPintasEResepActionPerformed
        if (TNoRw.getText().trim().equals("")) {
            JOptionPane.showMessageDialog(null, "Maaf, Silahkan anda pilih dulu dengan menklik data pada table...!!!");
            TCari.requestFocus();
        } else {
    ...
    }//GEN-LAST:event_BtnPintasEResepActionPerformed
    ...
    private void kdptg4KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_kdptg4KeyPressed
        if (evt.getKeyCode() == KeyEvent.VK_PAGE_DOWN) {
            NamaPetugas.setText(petugas.tampil3(kdptg4.getText()));
        } else if (evt.getKeyCode() == KeyEvent.VK_UP) {
            BtnSeekPetugasActionPerformed(null);
        } else {
            Valid.pindah(evt, TNoRw, BtnSeekPetugas4);
        }
    }//GEN-LAST:event_kdptg4KeyPressed

    private void BtnSeekPetugas4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSeekPetugas4ActionPerformed
        akses.setform("DlgRawatJalan");
        petugas.emptTeks();
        petugas.isCek();
        petugas.setSize(internalFrame1.getWidth() - 20, internalFrame1.getHeight() - 20);
        petugas.setLocationRelativeTo(internalFrame1);
        petugas.setVisible(true);
    }//GEN-LAST:event_BtnSeekPetugas4ActionPerformed
    ...
    private void tbProtokolKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tbProtokolKeyReleased
        if (TabModeProtokol.getRowCount() != 0) {
            if ((evt.getKeyCode() == KeyEvent.VK_ENTER) || (evt.getKeyCode() == KeyEvent.VK_UP) || (evt.getKeyCode() == KeyEvent.VK_DOWN)) {
                try {
                    getDataProtokol();
    ...
    }//GEN-LAST:event_tbProtokolKeyReleased

    private void BtnSeekPetugas4MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_BtnSeekPetugas4MouseClicked
        // TODO add your handling code here:
    }//GEN-LAST:event_BtnSeekPetugas4MouseClicked

    private void BtnSeekPetugasMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_BtnSeekPetugasMouseClicked
        // TODO add your handling code here:
    }//GEN-LAST:event_BtnSeekPetugasMouseClicked
...
// Masukkan ke param hanya jika ada data
    ...
    private void BtnSeek6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSeek6ActionPerformed
        if (TPasien.getText().trim().equals("") || TNoRw.getText().trim().equals("")) {
            ...
            pilihan = 2;
            this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
            soapterakhir.setNoRM(TNoRM.getText(), "D0000031", "Ralan");
            soapterakhir.setSize(internalFrame1.getWidth() - 20, internalFrame1.getHeight() - 20);
            soapterakhir.setLocationRelativeTo(internalFrame1);
            soapterakhir.setVisible(true);
            this.setCursor(Cursor.getDefaultCursor());
    ...
    private void MnAmbilTTDPasienActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnAmbilTTDPasienActionPerformed
        if (TNoRw.getText().trim().equals("")) {
    ...
    private javax.swing.JTextArea Anjuran;
    ...
    private widget.Button BtnPintasEResep;
    private widget.Button BtnPintasPermintaanLab;
    private widget.Button BtnPintasPermintaanRadiologi;
    private widget.Button BtnPintasResume;
    ...
    private widget.Button BtnSeekPetugas4;
    ...
    private widget.TextBox DiagnosaTerapi;
    private javax.swing.JDialog DlgCetak;
    private javax.swing.JTextArea Evaluasi;
    ...
    private javax.swing.JMenuItem MnAmbilTTDPasien;
    ...
    private javax.swing.JTextArea TataLaksana;
    ...
    private void isForm5() {
        if (ChkInput4.isSelected() == true) {
            ...
            PanelInput4.setPreferredSize(new Dimension(WIDTH, 140));
    ...
    private void tampilProtokol() {
        Valid.tabelKosong(TabModeProtokol);
        try {
            ps4 = koneksi.prepareStatement("SELECT rehab_program.no_rawat, pasien.no_rkm_medis, pasien.nm_pasien, "
                    ...
                    + "ON rehab_program.kd_petugas = petugas.nip INNER JOIN pasien ON reg_periksa.no_rkm_medis = pasien.no_rkm_medis where  "
                    + "rehab_program.tanggal between ? and ? and reg_periksa.no_rkm_medis like ? "
                    + (TCari.getText().trim().equals("") ? "" : "and (rehab_program.no_rawat like ? or reg_periksa.no_rkm_medis like ? or pasien.nm_pasien like ? or  "
                    + "rehab_program.program like ? or rehab_program.kd_petugas like ? or petugas.nama like ?) ")
                    + "order by rehab_program.no_rawat,rehab_program.tanggal,rehab_program.jam desc");
            try {
                ps4.setString(1, Valid.SetTgl(DTPCari1.getSelectedItem() + ""));
                ps4.setString(2, Valid.SetTgl(DTPCari2.getSelectedItem() + ""));
                ps4.setString(3, "%" + TCariPasien.getText() + "%");
    ...
    private void getDataProtokol() {
        if (tbProtokol.getSelectedRow() != -1) {
            TNoRw.setText(tbProtokol.getValueAt(tbProtokol.getSelectedRow(), 1).toString());
            TNoRM.setText(tbProtokol.getValueAt(tbProtokol.getSelectedRow(), 2).toString());
            TPasien.setText(tbProtokol.getValueAt(tbProtokol.getSelectedRow(), 3).toString());
            kdptg4.setText(tbProtokol.getValueAt(tbProtokol.getSelectedRow(), 6).toString());
            NamaPetugas.setText(tbProtokol.getValueAt(tbProtokol.getSelectedRow(), 7).toString());
            Catatan1.setText(tbProtokol.getValueAt(tbProtokol.getSelectedRow(), 8).toString());
            cmbJam.setSelectedItem(tbProtokol.getValueAt(tbProtokol.getSelectedRow(), 5).toString().substring(0, 2));
            cmbMnt.setSelectedItem(tbProtokol.getValueAt(tbProtokol.getSelectedRow(), 5).toString().substring(3, 5));
            cmbDtk.setSelectedItem(tbProtokol.getValueAt(tbProtokol.getSelectedRow(), 5).toString().substring(6, 8));
            Valid.SetTgl(DTPTgl, tbProtokol.getValueAt(tbProtokol.getSelectedRow(), 4).toString());
        }
    }
