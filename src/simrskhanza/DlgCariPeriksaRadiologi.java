   ...
   if(tabMode.getRowCount()!=0){
    ...
    private void BtnPrint1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrint1ActionPerformed
        if(Kd2.getText().equals("")){
            ...
            pilihan = (String)JOptionPane.showInputDialog(null,"Silahkan pilih hasil pemeriksaan..!","Hasil Pemeriksaan",JOptionPane.QUESTION_MESSAGE,null,new Object[]{"Model 1","Model 2", "Model 3","PDF Model 1","PDF Model 2","PDF Model 3","Upload Radiologi Ke Berkas Digital"},"Model 1");
            switch (pilihan) {
                case "Model 1":
        ...
        FileUploader.UploadPDF(FileName, "berkasrawat/pages/upload/", "RADIOLOGI", tbDokter,0);
                                  break;
            }                        
