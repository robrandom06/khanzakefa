...
private void tbDokterKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tbDokterKeyPressed
   if(tabMode.getRowCount()!=0){
                    ...
                    while(rs.next()){
                        ...
                        try {
                            ...
                            if(rspermintaan.next()){
                                ...
                                param.put("jampermintaan",rspermintaan.getString("jam_permintaan"));
                                //Valid.MyReport("rptPeriksaLabPermintaanMB.jasper","report","::[ Pemeriksaan Laboratorium ]::",param);   
                                Valid.MyReportPDFUpload("rptPeriksaLabPermintaanMB.jasper", "report", "::[ Pemeriksaan Laboratorium ]::",FileName, param);
                            }else{
                                //Valid.MyReport("rptPeriksaLabMB.jasper","report","::[ Pemeriksaan Laboratorium ]::",param);   
                                Valid.MyReportPDFUpload("rptPeriksaLabMB.jasper", "report", "::[ Pemeriksaan Laboratorium ]::",FileName, param);
                            }
                        } catch (Exception e) {
                            System.out.println("Notif : "+e);
                        } finally{
    ...
    private void berkasDigitalBtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_berkasDigitalBtnPrintActionPerformed
        // TODO add your handling code here:
        FileName = "LABORATORIUM_MB_"+ tbDokter.getValueAt(tbDokter.getSelectedRow(), 0).toString().replaceAll("/", "") + "_" ;
        CreatePDF(FileName);
        String filePath = "tmpPDF/" + FileName;
        FileUploader.UploadPDF(FileName, "berkasrawat/pages/upload/", "LABORATORIUM MB", tbDokter,0);
