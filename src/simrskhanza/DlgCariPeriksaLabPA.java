...
public class DlgCariPeriksaLabPA extends javax.swing.JDialog {
    ...
    private String diagnosa_klinik, makroskopik, mikroskopik, kesimpulan, kesan,Suspen_Piutang_Laborat_Ranap="",Laborat_Ranap="",Beban_Jasa_Medik_Dokter_Laborat_Ranap="",Utang_Jasa_Medik_Dokter_Laborat_Ranap="",
            ...
            Beban_Jasa_Perujuk_Laborat_Ralan="",Utang_Jasa_Perujuk_Laborat_Ralan="",Beban_Jasa_Menejemen_Laborat_Ralan="",Utang_Jasa_Menejemen_Laborat_Ralan="",status="",FileName="";
    ...
    private void initComponents() {
        ...
        berkasDigital = new javax.swing.JMenuItem();
        ...
        berkasDigital.setBackground(new java.awt.Color(255, 255, 254));
        berkasDigital.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        berkasDigital.setForeground(new java.awt.Color(50, 50, 50));
        berkasDigital.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        berkasDigital.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        berkasDigital.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        berkasDigital.setLabel("Upload Hasil Lab Ke Berkas Digital");
        berkasDigital.setName("berkasDigital"); // NOI18N
        berkasDigital.setPreferredSize(new java.awt.Dimension(190, 26));
        berkasDigital.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                berkasDigitalBtnPrintActionPerformed(evt);
            }
        });
        jPopupMenu1.add(berkasDigital);
...
private void tbDokterKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tbDokterKeyPressed
   if(tabMode.getRowCount()!=0){
                    ...
                    while(rs.next()){
                        ...
                        try {
                            ...
                            if(rspermintaan.next()){
                                ...
                                param.put("jampermintaan",rspermintaan.getString("jam_permintaan"));
                                //Valid.MyReport("rptPeriksaLabPermintaanPA.jasper","report","::[ Pemeriksaan Laboratorium ]::",param);   
                                Valid.MyReportPDFUpload("rptPeriksaLabPermintaanPA.jasper", "report", "::[ Pemeriksaan Laboratorium ]::",FileName, param);
                            }else{
                                //Valid.MyReport("rptPeriksaLabPA.jasper","report","::[ Pemeriksaan Laboratorium ]::",param);  
                                Valid.MyReportPDFUpload("rptPeriksaLabPA.jasper", "report", "::[ Pemeriksaan Laboratorium ]::",FileName, param);
                            }
                        } catch (Exception e) {
                            System.out.println("Notif : "+e);
                        } finally{
    ...
    private void berkasDigitalBtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_berkasDigitalBtnPrintActionPerformed
        // TODO add your handling code here:
        FileName = "LABORATORIUM_PA_"+ tbDokter.getValueAt(tbDokter.getSelectedRow(), 0).toString().replaceAll("/", "") + "_" ;
        CreatePDF(FileName);
        String filePath = "tmpPDF/" + FileName;
        FileUploader.UploadPDF(FileName, "berkasrawat/pages/upload/", "LABORATORIUM PA", tbDokter,0);
    }//GEN-LAST:event_berkasDigitalBtnPrintActionPerformed
    ...
    */
    ...
    private javax.swing.JMenuItem berkasDigital;
