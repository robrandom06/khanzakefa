...
private void tbDokterKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tbDokterKeyPressed
   if(tabMode.getRowCount()!=0){
    ...
    private void berkasDigitalBtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_berkasDigitalBtnPrintActionPerformed
        // TODO add your handling code here:
        FileName = "LABORATORIUM_"+ tbDokter.getValueAt(tbDokter.getSelectedRow(), 0).toString().replaceAll("/", "") + "_" ;
        CreatePDF(FileName);
        String filePath = "tmpPDF/" + FileName;
        FileUploader.UploadPDF(FileName, "berkasrawat/pages/upload/", "LABORATORIUM", tbDokter,0);
