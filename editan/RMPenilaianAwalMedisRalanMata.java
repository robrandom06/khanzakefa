...
//        })
        tabMode=new DefaultTableModel(null,new Object[]{
            "No.Rawat","No.RM","Nama Pasien","Tgl.Lahir","J.K.","Kode Dokter","Nama Dokter","Tanggal","Anamnesis","Hubungan","Keluhan Utama","Riwayat Penyakit Sekarang","Riwayat Penyakit Dahulu",
            "Riwayat Penggunakan Obat","Riwayat Alergi","Status Nutrisi","TD(mmHg)","Nadi(x/menit)","RR(x/menit)","Suhu","Nyeri","BB(Kg)","Keterangan kanan","Keterangan Kiri","Laboratorium","Radiologi","Penunjang Lainnya","Tes Penglihatan","Pemeriksaan Lain","Diagnosis/Asesmen","Diagnosis Banding","Permasalahan",
            "Terapi/Pengobatan","Tindakan","Edukasi"
...
//            }
        ...
        Ketkanan.setDocument(new batasInput((int)100).getKata(Ketkanan));
        Ketkiri.setDocument(new batasInput((int)100).getKata(Ketkiri));
...
//        MBOkiri.setDocument(new batasInput((int)100).getKata(MBOkiri));
    ...
    private void initComponents() {
        ...
        Ketkiri = new javax.swing.JTextArea();
        jScrollPane2 = new javax.swing.JScrollPane();
        Ketkanan = new javax.swing.JTextArea();
        ...
        Ketkiri.setColumns(20);
        Ketkiri.setRows(5);
        Ketkiri.setName("Ketkiri"); // NOI18N
        jScrollPane1.setViewportView(Ketkiri);

        FormInput.add(jScrollPane1);
        jScrollPane1.setBounds(530, 470, 290, 370);

        jScrollPane2.setName("jScrollPane2"); // NOI18N

        Ketkanan.setColumns(20);
        Ketkanan.setRows(5);
        Ketkanan.setName("Ketkanan"); // NOI18N
        jScrollPane2.setViewportView(Ketkanan);

        FormInput.add(jScrollPane2);
        jScrollPane2.setBounds(60, 470, 290, 370);
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(TNoRM.getText().trim().equals("")){
            ...
            if(Sequel.menyimpantf("penilaian_medis_ralan_mata","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?","No.Rawat",32,new String[]{
                    ...
                    Ketkanan.getText(),Ketkiri.getText(),
    ...
    private void StatusNutrisiKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_StatusNutrisiKeyPressed
        Valid.pindah(evt,Nyeri,Ketkanan);
    ...
    private void LaboratKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_LaboratKeyPressed
        Valid.pindah2(evt,Ketkiri,Radiologi);
    ...
    */
    ...
    private javax.swing.JTextArea Ketkanan;
    private javax.swing.JTextArea Ketkiri;
...
//        MBOkiri.setText("");
    ...
    private void getData() {
        if(tbObat.getSelectedRow()!= -1){
            ...
            Ketkanan.setText(tbObat.getValueAt(tbObat.getSelectedRow(),22).toString());
            Ketkiri.setText(tbObat.getValueAt(tbObat.getSelectedRow(),23).toString());
...
//            MBOkiri.setText(tbObat.getValueAt(tbObat.getSelectedRow(),49).toString());
            Laborat.setText(tbObat.getValueAt(tbObat.getSelectedRow(),24).toString());
            Radiologi.setText(tbObat.getValueAt(tbObat.getSelectedRow(),25).toString());
            Penunjang.setText(tbObat.getValueAt(tbObat.getSelectedRow(),26).toString());
            TesPenglihatan.setText(tbObat.getValueAt(tbObat.getSelectedRow(),27).toString());
            PemeriksaanLain.setText(tbObat.getValueAt(tbObat.getSelectedRow(),28).toString());
            ...
            Edukasi.setText(tbObat.getValueAt(tbObat.getSelectedRow(),34).toString());
...
//               emptTeks();
//               TabRawat.setSelectedIndex(1);
//        Permintaan Edit dr Spesialis Mata Leona Kefa}
        if(Sequel.mengedittf("penilaian_medis_ralan_mata","no_rawat=?","no_rawat=?,tanggal=?,kd_dokter=?,anamnesis=?,hubungan=?,keluhan_utama=?,rps=?,rpd=?,rpo=?,alergi=?,status=?,td=?,nadi=?,rr=?,suhu=?,"+
                "nyeri=?,bb=?,visuskanan=?,visuskiri=?,cckanan=?,cckiri=?,palkanan=?,palkiri=?,conkanan=?,conkiri=?,corneakanan=?,corneakiri=?,coakanan=?,coakiri=?,pupilkanan=?,pupilkiri=?,lensakanan=?,lensakiri=?,funduskanan=?,funduskiri=?,papilkanan=?,papilkiri=?,retinakanan=?,retinakiri=?,"+
                "makulakanan=?,makulakiri=?,tiokanan=?,tiokiri=?,mbokanan=?,mbokiri=?,ketkanan=?,ketkiri=?,lab=?,rad=?,penunjang=?,tes=?,pemeriksaan=?,diagnosis=?,diagnosisbdg=?,permasalahan=?,terapi=?,tindakan=?,edukasi=?",59,new String[]{
                TNoRw.getText(),Valid.SetTgl(TglAsuhan.getSelectedItem()+"")+" "+TglAsuhan.getSelectedItem().toString().substring(11,19),KdDokter.getText(),Anamnesis.getSelectedItem().toString(),Hubungan.getText(),
                    KeluhanUtama.getText(),RPS.getText(),RPD.getText(),RPO.getText(),Alergi.getText(),StatusNutrisi.getText(),TD.getText(),Nadi.getText(),RR.getText(),Suhu.getText(),Nyeri.getText(),BB.getText(),
                    Ketkanan.getText(),Ketkiri.getText(),
                    Laborat.getText(),Radiologi.getText(),Penunjang.getText(),TesPenglihatan.getText(),PemeriksaanLain.getText(),
